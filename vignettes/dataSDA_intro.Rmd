...
subtitle: "Supplementary material for dataSDA: datasets and basic statistics for symbolic data analysis in R"
...
# Installed packages store lazy data in databases rather than individual .rda
# files. Use R's dataset index so this also works during R CMD check.
data_names <- unique(utils::data(package = "dataSDA")$results[, "Item"])
